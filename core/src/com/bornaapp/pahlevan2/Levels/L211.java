...
public class L211 extends LevelBase {
    public L211() {
        super("assetManifest_L211.json");
    }

    private Naruto naruto1;
    private Pedestrian vendor;
    private boolean chase = true;

    @Override
    protected void onCreate() {
        getPlayGround().load("L211.tmx");
        //
        //Ashley
        ...
        vendor = new Pedestrian("man5.atlas", 200, 200);
        //
        naruto1.bodyComp.body.setTransform(getCheckpoint("narutu_start"), 0);
        //
        vendor.bodyComp.body.setTransform(getCheckpoint("vendor_start"), 0);
        vendor.addCheckPoint(getCheckpoint("vendor_start"));
        vendor.addCheckPoint(getCheckpoint("vendor_stop"));
